    ...
    new Chart(lineCtx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor          : COLORS['up-maroon'],
          pointBackgroundColor : COLORS['up-maroon'],
          borderWidth          : 2,
          data                 : [60, 50, 70, 60, 50, 70, 60],
        }, {
          label                : 'Series B',
          backgroundColor      : 'rgba(232, 245, 233, 0.5)',
          borderColor          : COLORS['up-green'],
          pointBackgroundColor : COLORS['up-green'],
          borderWidth          : 2,
  ...
  if (barChartBox) {
    ...
    new Chart(barCtx, {
      ...
      data: {
        ...
        datasets: [{
          label           : 'Dataset 1',
          backgroundColor : COLORS['up-maroon'],
          borderColor     : COLORS['up-maroon'],
          borderWidth     : 1,
          data            : [10, 50, 20, 40, 60, 30, 70],
        }, {
          label           : 'Dataset 2',
          backgroundColor : COLORS['up-green'],
          borderColor     : COLORS['up-green'],
          borderWidth     : 1,
          data            : [10, 50, 20, 40, 60, 30, 70],
        }],
